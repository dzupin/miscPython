...
print ("------------ **** ------------")
print appAion[u'Title'].Texts()
print appAion[u'Title'].WindowText()
print appAion[u'Title'].GetProperties()
print appAion[u'Title']['OK'].Texts()
print appAion[u'Title']['OK'].GetProperties()
print ("------------ **** ------------")
